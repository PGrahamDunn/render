            ...
            <div class="flex items-center justify-between">
                <div class="max-w-lg w-full lg:max-w-xs">
                    ...
                    <div class="flex space-x-1">
                        ...
                        <input wire:model.live="search" id="search" class="block w-full pl-3 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:border-blue-300 focus:shadow-outline-blue sm:text-sm transition duration-150 ease-in-out" placeholder="Search" type="search">
                    </div>
                </div>
