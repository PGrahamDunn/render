...
<div class="border border-gray-300 bg-gray-100 p-2 mb-4 rounded-md text-xs font-mono">
    ...
    <div class="border border-gray-300 bg-white col-span-1 rounded-md">
        ...
        <div class="p-2 space-y-6 mx-2 divide-y divide-gray-300">
            ...
            <div class="space-y-3">
                ...
                @if((config('app.env') == 'local') and (strlen($personalization_string) > 2))
                <div class="border border-gray-300 bg-gray-100 p-2 m-2 rounded-md text-xs font-mono">{{ $personalization_string }}</div>
                @endif
            </div>
            <!-- render it -->
            <div class="space-y-3">
            ...
            <div class="space-y-3">
                ...
                @if((config('app.env') == 'local') and (strlen($customization_string) > 2))
                <div class="border border-gray-300 bg-gray-100 p-2 m-2 rounded-md text-xs font-mono">{{ $customization_string }}</div>
                @endif
            </div>
            @endif
            <!-- submit it -->
