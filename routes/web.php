...
Route::get('/actuate', [UtilityController::class, 'actuate'])->middleware(['auth', 'verified'])->name('utility.actuate')->can('admin');
...
Route::get('/seeddatabase', [RenderController::class, 'seed_database'])->middleware(['auth', 'verified'])->name('seed.database');
